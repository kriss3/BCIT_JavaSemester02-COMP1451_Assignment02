...
public class Marianne
{
    ...
    private static final String[] CLASSNAME_OF = new String[] {
            "pl.kriss3.bcit.comp1451.Airplane",
            "pl.kriss3.bcit.comp1451.Boat",
            "pl.kriss3.bcit.comp1451.Car",
            "pl.kriss3.bcit.comp1451.Vehicle",
            "pl.kriss3.bcit.comp1451.ISteerable",
    ...
    private static final String[][] TEST_STRINGS = new String[][] {
            new String[] {
                "Adding more knots (kt)!" + NEWLINE,
                "Flying LEFT and Down !!!" + NEWLINE,
                "Flying RIGHT and Down !!!" + NEWLINE,
                "This airplane is a 1970 Make Model that can reach 1333 feet.",
                "This airplane is a 2000 Fake Yodel that can reach 332 feet.",
            },

            new String[] {
                "Adding more nautical knots!" + NEWLINE,
                "Port - Turn the boat left" + NEWLINE,
                "Starboard - Turn the boat right" + NEWLINE,
                "This boat is a 1970 Make Model (with motor).",
                "This boat is a 2000 Fake Yodel (without motor).",
            },

            new String[] {
                "Car is INCREASING speed!" + NEWLINE,
                "Car is turning LEFT!" + NEWLINE,
                "Car is turning RIGHT!" + NEWLINE,
    ...
    public void allInstanceVariablesHaveGettersAndSetters()
    {
        ...
        enforceGoodFieldPractices(BOAT, "isMotorized");
